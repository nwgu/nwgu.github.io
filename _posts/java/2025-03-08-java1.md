...
1. 각 학생의 이름을 키로, 과목 이름을 값으로 하는 HashMap을 생성하세요.
...
<!-- 문제 6: HashMap을 사용한 데이터 검색
목표: HashMap을 사용하여 직원들의 이름과 급여를 저장하고, 특정 직원의 급여를 검색하는 프로그램을 작성하세요.

1. 직원 이름을 키로, 급여를 값으로 하는 HashMap을 생성하세요.
2. 직원 5명의 이름과 급여를 입력받아 HashMap에 저장하세요.
3. 사용자가 입력한 직원 이름에 대해 급여를 출력하는 기능을 구현하세요.
...
검색할 직원 이름을 입력하세요: 김영희
김영희의 급여는 55000원입니다.
```


문제 7: ArrayList와 HashMap을 활용한 전화번호부
목표: ArrayList와 HashMap을 사용하여 전화번호부를 만드는 프로그램을 작성하세요.

1. HashMap을 사용하여 각 사람의 이름과 전화번호를 저장하세요.
2. ArrayList에 전화번호부에 등록된 사람들의 이름을 저장하고, 이름을 기준으로 전화번호를 출력하는 기능을 구현하세요.

```bash
예시 입력 및 출력:
전화번호부에 등록된 이름: 홍길동, 김영희, 박철수

홍길동의 전화번호는 010-1234-5678입니다.
김영희의 전화번호는 010-2345-6789입니다.
박철수의 전화번호는 010-3456-7890입니다.
``` --> 